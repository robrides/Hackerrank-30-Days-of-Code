...
import java.util.*;
// import pk1.pkg2.----.pkn.class; or ----.pkn.*;
// more efficient just to import the classes you need instead of all
import java.io.*;

public class LibraryCatalogue {

    // Dictionaries Properties/Fields/Global Variables
    ...
    public static void main(String[] args) {
        ...
        Map<String,Book> bookCollection = new HashMap<String,Book>();
        Book harry = new Book("Harry Potter", 9898, 99999999);
