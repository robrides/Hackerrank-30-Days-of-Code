...
public class MadLibs {
    ...
    public void setRandomNums() {
        ...
        // Set index to zero
        int index = 0;
        // Create an array; rows of seats that have a different person in each; 
        // must be same type (all int, all double, etc)
        int[] numberHolder = new int[3];
        // while the index originally set to zero is less than the 
        // numberHolder.length which is 3 as set by new int[3]; 
        // access the numberHolder seats (0,1,2,3)
        // Example: if the random num is 10 we'll have 
        // 10 + 0 = 10 in the first seat
        // 10 + 1 = 11 in the second seat
        // 10 + 2 = 12 in the third seat        
    ...
    public void putTogetherTheStory(){
        ...
        if (num == 0) {
            ...
            story = "Amanda and her frenemy " +getName()+" went to the zoo last summer." +
                ...
                + ". That night"+" they decide to climb "+getAdverb()+" into the "+ getNoun3()
